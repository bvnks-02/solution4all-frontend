// FILE: solution4all-frontend/src/admin/AdminActivateAccount.jsx
...
export default function AdminActivateAccount() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err?.response?.data?.message || "Lien d'activation invalide ou expiré.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-neutral-900">Activez votre compte</h1>
          <p className="mt-2 text-sm text-neutral-500">Définissez votre mot de passe pour activer votre compte.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-card border border-neutral-200/60 p-6 md:p-8">
          {success ? (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm text-neutral-700 font-medium">Compte activé avec succès !</p>
              <p className="text-sm text-neutral-500">Vous pouvez maintenant vous connecter.</p>
              <button
