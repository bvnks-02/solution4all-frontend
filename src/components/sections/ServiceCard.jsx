    ...
    return (
      <div className="group bg-white rounded-xl shadow-card border border-neutral-200/60 p-6 md:p-8 hover:shadow-card-hover hover:-translate-y-1 transition-all duration-250 ease-spring reveal-item">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-1.5 rounded-md text-sm font-semibold text-brand-navy hover:text-brand-gold transition-colors duration-200 group/link focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-navy focus-visible:ring-offset-2"
        >
          En savoir plus
    ...
    <div className="group bg-white rounded-xl shadow-card border border-neutral-200/60 p-6 md:p-8 hover:shadow-card-hover hover:-translate-y-1 transition-all duration-250 ease-spring">
      ...
      <ul className="mt-4 space-y-2">
        {service.features.map((feature) => (
          <li key={feature} className="flex items-start gap-2 text-sm text-neutral-700">
            <Check size={16} strokeWidth={2.5} className="text-brand-gold mt-0.5 shrink-0" aria-hidden="true" />
            {feature}
          </li>
        ))}
      </ul>
      <div className="mt-6 flex flex-wrap gap-3">
        <Link
          ...
          className="inline-flex items-center justify-center font-display font-semibold rounded-lg bg-brand-gold text-neutral-900 shadow-sm hover:bg-brand-goldDark hover:-translate-y-0.5 hover:shadow-card-hover transition-[color,background-color,transform,box-shadow] duration-250 ease-spring px-5 py-2.5 text-sm gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-goldDark focus-visible:ring-offset-2"
        >
          Demander un devis
        </Link>
        <Link
          to="/contact"
          className="inline-flex items-center justify-center font-display font-semibold rounded-lg border-2 border-brand-navy text-brand-navy bg-transparent hover:bg-brand-navy hover:text-white hover:-translate-y-0.5 hover:shadow-card-hover transition-[color,background-color,transform,box-shadow,border-color] duration-250 ease-spring px-5 py-2.5 text-sm gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-navy focus-visible:ring-offset-2"
        >
          Nous contacter
        </Link>
      </div>
